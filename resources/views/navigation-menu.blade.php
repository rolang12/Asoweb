<nav x-data="{ open: false }" class="bg-cyan-900 border-b z-50 fixed w-full  border-gray-100">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('inicio') }}">
                        <!-- logo de asotrauma -->
                        <img src="{{ asset('imagenes/logo1.png') }}" alt="img" width="50" height="50">
                    </a>
                </div>
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    ...
                    <div class="my-auto w-100 text-right flex flex-row justify-end">
                        ...
                        <livewire:notificacion-mensaje />
                        <livewire:notificaciones />
                       

                        {{-- <x-jet-nav-link href="{{ route('chatify') }}" :active="request()->routeIs('chatify')">
                            <i class=" fa-solid fa-messages text-white text-lg hover:text-gray-200"></i>
                        </x-jet-nav-link> --}}
